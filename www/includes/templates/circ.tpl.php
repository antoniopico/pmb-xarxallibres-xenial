...
if ((SESSrights & RESTRICTCIRC_AUTH) && ($categ!="pret") && ($categ!="pretrestrict") ) {
	...
	<ul>
		...
		<li id='circ_menu_msgxarxa'><a href='./circ.php?categ=retour_xarxa&id_empr=691'>Dev. Múltiple</a></li>
...
<!-- ---------------------------- LLIUREX 10/03/2016 --------------------------------- -->
		...
		<li><a href='./circ.php?categ=carnetsUsuarios'>$msg[cataleg_Document_Carnet]</a></li>
		<li><a href='./circ.php?categ=carnetsUsuariosMigrados'>$msg[carnet_Migrados]</a></li>
