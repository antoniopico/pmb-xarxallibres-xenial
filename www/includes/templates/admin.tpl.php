...
//-------------------- LLIUREX 09/03/2016------------------
// A\F1adimos importar usuarios GESCEN/ ITACA
	$admin_menu_empr .= "
	<span".ongletSelect("categ=empr&sub=imple").">
		<a title='$msg[import_lec_alt]' href='./admin.php?categ=empr&sub=imple&action='>
			$msg[import_lec_biblio]
		</a>
	</span>
<!-- A\F1adimos importar desde ITACA -->
	<span".ongletSelect("categ=empr&sub=itaca").">
		<a title='$msg[import_usu_from_itaca_b]' href='./admin.php?categ=empr&sub=itaca&action='>
			$msg[import_usu_from_itaca_b]
		</a>
	</span>
<!--A\F1adimos exportar fichero --> 
	<span".ongletSelect("categ=empr&sub=export").">
		<a title='$msg[usur_exp_b]' href='./admin.php?categ=empr&sub=export&action='>
			$msg[usur_exp_b]
		</a>
	</span>";
...
<!-- LLIUREX 09/03/2016 -->
<span".ongletSelect("categ=empr&sub=migration").">
		<a title='$msg[usur_migr_menu]' href='./admin.php?categ=empr&sub=migration&action='>
			$msg[usur_migr_menu]
		</a>
	</span>
<!-- FIN LLIUREX 09/03/2016 -->
...
<!-- LLIUREX 09/03/2016 -->
<!-- Añadimos importar registros de REBECA -->
	<span".ongletSelect("categ=import&sub=import_reb").">
		<a href='./admin.php?categ=import&sub=import_reb&action='>
			".$msg["import_reb"]."
		</a>
	</span>
<!-- FIN LLIUREX 09/03/2016 -->
...
<!-- LLIUREX 07/04/2017 -->
<!-- Añadimos importar registros de ABIES -->
	<span".ongletSelect("categ=import&sub=import_abies").">
		<a title='$msg[import_abies]' href='./admin.php?categ=import&sub=import_abies&action='>
			$msg[import_abies]
		</a>
	
	</span>
	 
<!-- FIN LLIUREX 07/04/2017 -->
...
<!-- LLIUREX 09/03/2016 -->
<!-- LLIUREX 01/02/2017
	<span/".ongletSelect("categ=tradu").">
		<a title='$msg[tradu_tablas]' href='./admin.php?categ=misc&sub=tradu'>
			$msg[tradu_tablas]
		</a>
	</span>
LLIUREX 01/02/2017 -->
...
<!-- LLIUREX 01/02/2017
	...
	LLIUREX 01/01/2017-->
<!-- LLIUREX 09/03/2016 -->
<!-- Copias de seguridad de lliurex -->
	<span".ongletSelect("categ=sauvegarde&sub=lliurexp").">
		<a title='$msg[copia_seg_a]' href='./admin.php?categ=sauvegarde&sub=lliurexp'>
			$msg[copia_seg_b]
		</a>
	</span>
	<span".ongletSelect("categ=sauvegarde&sub=lliureimp").">
		<a title='$msg[copia_seg_c]' href='./admin.php?categ=sauvegarde&sub=lliureximp'>
			$msg[copia_seg_d]
		</a>
	</span>
<!-- FIN LLIUREX 09/03/2016 -->
