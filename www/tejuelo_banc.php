...
//---------------------LLIUREX 12/02/2015 -------------------------
        require_once ("$base_path/includes/init.inc.php");
//--------------------- FIN LLIUREX 12/02/2015 -------------------------
	echo "<center><form class='form-admin' name='form2' ENCTYPE=\"multipart/form-data\" method='get' action=\"./tejuelo_banc.php?codigos=\".$codigos·\"\"><b>$msg[tejuelo_categoria]&nbsp;</b><input name='codigos' accept='text/plain' type='text'  size='80'><input align='center' type='button' name='continuar' value='Continuar' onclick='form.submit()'></form></center>";
break;}
...
$q = 'SELECT expl_cote, expl_cb, expl_notice
FROM exemplaires WHERE expl_notice  = \''.$codigos.'\' ';
