...
// +-------------------------------------------------+
// $Id: alter_vLlxTrusty.inc.php, migración BD a v5.19 (Lliurex 16.05 Xenial desde v.5.14 (Lliurex 15.05 Trusty)
...
//	case "v5.14": 
		// 5 actualizaciones desde trusty (v5.14) a xenial (v5.19)
		$increment=100/6;
		$action=$increment;
