...
$tpl_beforeupload_reb = "
                    <form class='form-$current_module' ENCTYPE='multipart/form-data' METHOD='post' ACTION='iimport_expl.php' />
                    <h3>".$msg['import_reb_form_titre']."</h3>
                    <div class='form-contenu'>
                        <div class='row'>
                            <label class='etiquette' for='txt_suite'>".$msg['import_reb_form_file']."</label>
                            </div>
                        <div class='row'>
                            <INPUT NAME='userfile' class='bouton' TYPE='file' size='60'>
                            <INPUT NAME='categ' TYPE='hidden' value='import'>
                            <INPUT NAME='sub' TYPE='hidden' value='import_reb'>
                            <INPUT NAME='action' TYPE='hidden' value='afterupload'>
                            </div>
                        </div>
                    <INPUT TYPE='SUBMIT' class='bouton' NAME='upload' VALUE='".$msg[502]."' />
